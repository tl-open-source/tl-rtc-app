const tl_rtc_app_module_contact_content_search_user = {
    props: {
        searchUserData: {
            type: Object,
            default: {
    ...
    methods: {
         ...
         */
        sendVideo: function(){
            this.$emit('send-video', this.propsSearchUserData)
        },
        /**
         * 发起语音
         */
        sendAudio: function(){
            this.$emit('send-audio', this.propsSearchUserData)
        },
        /**
         * 鼠标移入
         * @param {*} event 
    ...
    template: `
        <div class="tl-rtc-app-right-contact-content-search">
            ...
            <div class="tl-rtc-app-right-contact-content-tool" v-if="propsSearchUserData.isFriend && !propsSearchUserData.isSelf">
                ...
                <div class="tl-rtc-app-right-contact-content-tool-item">
                    <svg class="icon" aria-hidden="true" @click="sendVideo">
                        <use xlink:href="#tl-rtc-app-icon-shexiangtou"></use>
                    </svg>
                    <div>发起视频</div>
                </div>
                <div class="tl-rtc-app-right-contact-content-tool-item">
                    <svg class="icon" aria-hidden="true" @click="sendAudio">
...
window.tl_rtc_app_module_contact_content_search_user = tl_rtc_app_module_contact_content_search_user