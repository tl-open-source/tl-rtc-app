        ...
        propsTools(){
            if(this.propsChannelType === 'friend'){
                this.tools = this.tools.filter(tool => {
                    return tool.title !== '邀请进群' && tool.title !== '群公告';
                })
            }
    ...
    template: `
        <div class="tl-rtc-app-right-channel-content-top">
            ...
            >
                ...
                <svg class="icon tl-rtc-app-edit-channel-name" aria-hidden="true" @click="updateChannelName($event)" v-show="isChannelCreateor">
