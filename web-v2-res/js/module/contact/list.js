const tl_rtc_app_module_contact_list = {
    ...
    methods: {
         ...
         * @param {*} data 
         */
        updateApplyInfo: function(id, data){
        ...
        getContactList: async function(){
            ...
            this.specialContactList = this.contactList.filter(item => item.friendType === '特别关注')
         ...
         * 获取好友申请列表
         */
        getApplyContactList: async function(){
        ...
        <div class="tl-rtc-app-left-panel-contact">
            <div class="layui-collapse">
                <div class="layui-colla-item">
                    <h2 class="layui-colla-title">申请记录 ({{filterApplyContactList.length}})</h2>
